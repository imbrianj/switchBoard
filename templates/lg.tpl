      ...
      <section id="{{DEVICE_ID}}" class="{{DEVICE_TYPE}}{{DEVICE_SELECTED}}{{DEVICE_STATE}}">
        ...
        <div class="control-block">
          ...
          <div class="navigation">
            ...
            <a href="/?{{DEVICE_ID}}=OK" class="fa-stack">
        ...
        <div class="shortcuts">
          <ul>
            ...
            <li><a href="/?{{DEVICE_ID}}=External" class="fa fa-desktop"><span>{{i18n_EXTERNAL}}</span></a></li>
            <li><a href="/?{{DEVICE_ID}}=Info" class="fa fa-cog"><span>{{i18n_INFO}}</span></a></li>
