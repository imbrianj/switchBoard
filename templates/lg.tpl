      <div id="{{DEVICE_ID}}" class="device">
        <div class="control-block">
          <div class="volume">
            <a href="/?device={{DEVICE_ID}}&command=VOLUP" class="fa fa-volume-up"><span>Vol_Up</span></a>
            <a href="/?device={{DEVICE_ID}}&command=VOLDOWN" class="fa fa-volume-down"><span>Vol_Down</span></a>
          ...
          <div class="navigation">
            ...
            <a href="/?device={{DEVICE_ID}}&command=OK" class="fa-stack">
        ...
        <div class="shortcuts">
          <ul>
            ...
            <li><a href="/?device={{DEVICE_ID}}&command=EXTERNAL" class="fa fa-desktop"><span>External</span></a></li>
            <li><a href="/?device={{DEVICE_ID}}&command=INFO" class="fa fa-cog"><span>Info</span></a></li>
