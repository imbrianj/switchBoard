      ...
      <section id="{{DEVICE_ID}}" class="{{DEVICE_TYPE}}{{DEVICE_SELECTED}}{{DEVICE_STATE}}" data-string-docked="{{i18n_DOCKED}}" data-string-undocked="{{i18n_UNDOCKED}}">
        ...
        <div class="installed">
          <span class="fa fa-battery-{{DEVICE_STATE_BATTERY_CLASS}}{{DEVICE_STATE_CHARGING}}" title="{{i18n_BATTERY_LEVEL}}: {{DEVICE_BATTERY_LEVEL}}"> {{i18n_BATTERY_LEVEL}}: {{DEVICE_BATTERY_LEVEL}}</span>
