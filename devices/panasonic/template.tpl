      ...
      <section id="{{DEVICE_ID}}" class="{{DEVICE_TYPE}}{{DEVICE_SELECTED}}{{DEVICE_STATE}}">
        ...
        <div class="shortcuts">
          <ul>
            ...
            <li><a href="/?{{DEVICE_ID}}=Viera_Link" class="icon fa fa-th" title="{{i18n_VIERA_LINK}}"><span>{{i18n_VIERA_LINK}}</span></a></li>
            <li><a href="/?{{DEVICE_ID}}=Chg_Input" class="icon fa fa-desktop" title="{{i18n_CHANGE_INPUT}}"><span>{{i18n_CHANGE_INPUT}}</span></a></li>
            <li><a href="/?{{DEVICE_ID}}=Internet" class="icon fa fa-globe" title="{{i18n_INTERNET}}"><span>{{i18n_INTERNET}}</span></a></li>
            <li><a href="/?{{DEVICE_ID}}=HDMI4" class="icon fa fa-sitemap" title="{{i18n_HDMI}} 4"><span>{{i18n_HDMI}} 4</span></a></li>
            <li><a href="/?{{DEVICE_ID}}=Submenu" class="icon fa fa-cog" title="{{i18n_SUBMENU}}"><span>{{i18n_SUBMENU}}</span></a></li>
            <li><a href="/?{{DEVICE_ID}}=Menu" class="icon fa fa-list-ul" title="{{i18n_MENU}}"><span>{{i18n_MENU}}</span></a></li>
            <li><a href="/?{{DEVICE_ID}}=Cancel" class="icon fa fa-sign-out-alt" title="{{i18n_CANCEL}}"><span>{{i18n_CANCEL}}</span></a></li>
          </ul>
        </div>
        <div class="text">
        ...
        <div class="numeric-controls">
          ...
          <ul>
            <li><a href="/?{{DEVICE_ID}}=Return" class="icon fa fa-reply" title="{{i18n_RETURN}}"><span>{{i18n_RETURN}}</span></a></li>
            <li><a href="/?{{DEVICE_ID}}=Info" class="icon fa fa-list" title="{{i18n_INFO}}"><span>{{i18n_INFO}}</span></a></li>
          </ul>
        </div>
        <div class="media">
          <ul>
            <li><a href="/?{{DEVICE_ID}}=Rew" class="icon fa fa-backward" title="{{i18n_REWIND}}"><span>{{i18n_REWIND}}</span></a></li>
            <li><a href="/?{{DEVICE_ID}}=Sop" class="icon fa fa-stop" title="{{i18n_STOP}}"><span>{{i18n_STOP}}</span></a></li>
