      ...
      <section id="{{DEVICE_ID}}" class="{{DEVICE_TYPE}}{{DEVICE_SELECTED}}{{DEVICE_STATE}}">
        ...
        <div class="control-block full">
          <div class="media">
            <ul>
              <li><a href="/?{{DEVICE_ID}}=Instant_Replay" class="icon fa fa-backward" title="{{i18n_INSTANT_REPLAY}}"><span>{{i18n_INSTANT_REPLAY}}</span></a></li>
              <li><a href="/?{{DEVICE_ID}}=Play" class="icon fa fa-play" title="{{i18n_PLAY}}"><span>{{i18n_PLAY}}</span></a></li>
              <li><a href="/?{{DEVICE_ID}}=Fwd" class="icon fa fa-forward" title="{{i18n_FORWARD}}"><span>{{i18n_FORWARD}}</span></a></li>
            </ul>
          </div>
          ...
          <div class="shortcuts">
            <ul>
              <li><a href="/?{{DEVICE_ID}}=Back" class="icon fa fa-undo" title="{{i18n_BACK}}"><span>{{i18n_BACK}}</span></a></li>
              <li><a href="/?{{DEVICE_ID}}=Home" class="icon fa fa-home" title="{{i18n_HOME}}"><span>{{i18n_HOME}}</span></a></li>
              <li><a href="/?{{DEVICE_ID}}=Backspace" class="icon fas fa-long-arrow-alt-left" title="{{i18n_BACKSPACE}}"><span>{{i18n_BACKSPACE}}</span></a></li>
            </ul>
          </div>
        </div>
        <div class="text">
